      ...
      Get["/record"] = x => {
        ...
        resp.AddRecord(new Dictionary < string, string > () {
          ...
          }, // Submit the result of the record to this URL
          {
            "method",
            "GET"
          }, // HTTP method to submit the action URL
          {
            "callbackUrl",
            "http://dotnettest.apphb.com/record_callback"
          }, // If set, this URL is fired in background when the recorded file is ready to be used.
          {
            "callbackMethod",
            "GET"
